...
async def consumer_callback(msg_body):
    ...
    # => 個人訂閱
    await _offline_service.batch_write_items(msg_body)
...
async def connect(sid, environ, auth):
    ...
    history_msgs = _offline_service.get_history_msgs(role_id, role)
...
async def message(sid, payload):
    ...
    _offline_service.msg_read(role_id, role, data)
